...
.단계
. System Manager에서 섀시 일련 번호를 찾아 기록합니다. 왼쪽 패널에서 menu:Support[Support Center]로 이동하여 *상위 스토리지 어레이 속성 보기*로 스크롤하여 섀시 일련 번호를 확인합니다.
. System Manager에서 Feature Enable Identifier를 찾습니다. 왼쪽 패널에서 menu:Settings[System]으로 이동한 다음 아래로 스크롤하여 *Add-ons*를 찾습니다. *Feature Enable Identifier*를 찾습니다. Feature Enable Identifier의 번호를 기록합니다.
