...
---
= SANtricity System Manager에서 호스트 설정 변경
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.단계
. 왼쪽 패널에서 menu:Storage[Hosts]를 선택합니다.
. 편집할 호스트를 선택한 다음 menu:ellipsis icon[Edit Settings]을 클릭합니다.
+
현재 호스트 설정을 보여주는 창이 나타납니다.
