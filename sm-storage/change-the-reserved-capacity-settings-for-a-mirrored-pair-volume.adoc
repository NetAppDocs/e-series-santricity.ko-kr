...
. 편집할 미러링된 쌍 볼륨을 선택한 다음 menu:ellipsis icon[Edit Settings]을 클릭합니다.
+
미러링된 쌍 볼륨 예약된 용량 설정 편집 창이 나타납니다.
...
예약된 용량 전체 알림 임계값
 a| 
막대를 사용하여 미러링된 쌍의 예약된 용량이 거의 찼을 때 System Manager가 알림 통지를 보내는 백분율 지점을 조정합니다.
