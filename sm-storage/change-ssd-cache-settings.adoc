...
summary: SSD Cache 설정을 편집할 수 있습니다. SSD Cache의 현재 설정은 설정 보기 옵션을 통해 액세스할 수 있습니다. 
---
...
[role="lead"]
SSD Cache 설정을 편집할 수 있습니다. SSD Cache의 현재 설정은 설정 보기 옵션을 통해 액세스할 수 있습니다.

.단계
. 왼쪽 패널에서 menu:Storage[Pools and volume groups]를 선택합니다.
. 편집하려는 SSD Cache를 선택한 다음 menu:ellipsis icon[Edit Settings]을 클릭합니다.
+
SSD 캐시 설정 편집 창이 나타납니다.
