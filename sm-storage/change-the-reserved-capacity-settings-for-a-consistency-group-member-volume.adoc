...
. 예약된 용량 * 탭을 클릭합니다.
. 편집하려는 일관성 그룹 멤버 볼륨을 선택한 다음 menu:줄임표 아이콘[설정 편집]을 클릭합니다.
+
일관성 그룹 구성원 볼륨 편집 창이 나타납니다.
...
예약된 용량 전체 알림 임계값
 a| 
막대를 사용하여 구성원 볼륨의 예약된 용량이 거의 가득 찼을 때 System Manager가 알림 통지를 보내는 백분율 지점을 조정합니다.
