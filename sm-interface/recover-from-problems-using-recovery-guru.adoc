...
.단계
. 왼쪽 패널에서 *홈*을 선택합니다.
. *Bell* 아이콘을 클릭한 다음 창 중앙 상단에 있는 *Recover from _n_ problems* 링크를 클릭하세요.
+
...
+
해당 파일은 브라우저의 다운로드 폴더에 `recoveryGuru-failureName-arrayName-yyyy-mm-dd-hh-mm-ss.html`이라는 이름으로 저장됩니다.
